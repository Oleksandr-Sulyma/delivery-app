...
import { Layout, Badge, Button, Drawer, Space, Flex, Tooltip, theme } from "antd";
import {
  MenuOutlined,
                  ...
                  <div key={link.href} style={{ display: "flex", alignItems: "center" }}>
                    ...
                    >
                      ...
                      {link.hasBadge && totalItems > 0 && (
                        <Badge count={totalItems} size="small" style={{ marginLeft: "8px" }} />
                      )}
                    </Link>
          ...
          {navLinks.map((link) => {
            ...
            return (
              ...
              >
                ...
                {link.hasBadge && totalItems > 0 && (
                  <Badge count={totalItems} style={{ backgroundColor: token.colorError }} />
                )}
              </Link>
            );
          })}
